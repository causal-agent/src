...
theme.taglist_squares_sel   = ".config/awesome/themes/Tomorrow-Night/taglist/squarefz.png"
theme.taglist_squares_unsel = ".config/awesome/themes/Tomorrow-Night/taglist/squarez.png"
